...
const (
	// 待执行
	DownloadTaskStatus_DownloadTaskStatusPending DownloadTaskStatus = 1
	// 执行中
	DownloadTaskStatus_DownloadTaskStatusRunning DownloadTaskStatus = 2
	// 失败
	DownloadTaskStatus_DownloadTaskStatusFail DownloadTaskStatus = 3
	// 死信
	DownloadTaskStatus_DownloadTaskStatusDead DownloadTaskStatus = 4
	// 成功
	DownloadTaskStatus_DownloadTaskStatusSuccess DownloadTaskStatus = 5
)

func (p DownloadTaskStatus) String() string {
	switch p {
	case DownloadTaskStatus_DownloadTaskStatusPending:
		return "DownloadTaskStatusPending"
	case DownloadTaskStatus_DownloadTaskStatusRunning:
		return "DownloadTaskStatusRunning"
	case DownloadTaskStatus_DownloadTaskStatusFail:
		return "DownloadTaskStatusFail"
	case DownloadTaskStatus_DownloadTaskStatusDead:
		return "DownloadTaskStatusDead"
	case DownloadTaskStatus_DownloadTaskStatusSuccess:
		return "DownloadTaskStatusSuccess"
	}
	return "<UNSET>"
}

func DownloadTaskStatusFromString(s string) (DownloadTaskStatus, error) {
	switch s {
	case "DownloadTaskStatusPending":
		return DownloadTaskStatus_DownloadTaskStatusPending, nil
	case "DownloadTaskStatusRunning":
		return DownloadTaskStatus_DownloadTaskStatusRunning, nil
	case "DownloadTaskStatusFail":
		return DownloadTaskStatus_DownloadTaskStatusFail, nil
	case "DownloadTaskStatusDead":
		return DownloadTaskStatus_DownloadTaskStatusDead, nil
	case "DownloadTaskStatusSuccess":
		return DownloadTaskStatus_DownloadTaskStatusSuccess, nil
	}
	return DownloadTaskStatus(0), fmt.Errorf("not a valid DownloadTaskStatus string")
}

func DownloadTaskStatusPtr(v DownloadTaskStatus) *DownloadTaskStatus { return &v }
func (p *DownloadTaskStatus) Scan(value interface{}) (err error) {
	var result sql.NullInt64
	err = result.Scan(value)
	*p = DownloadTaskStatus(result.Int64)
	return
}

func (p *DownloadTaskStatus) Value() (driver.Value, error) {
	if p == nil {
		return nil, nil
	}
	return int64(*p), nil
...
var ListPixivImageMetaInfoRequest_Status_DEFAULT StatusMode
...
type DownloadTask struct {
	IllustID     string             `thrift:"illust_id,1,required" bson:"illust_id" form:"illust_id,required" json:"illust_id,required" query:"illust_id,required"`
	R18Index     int32              `thrift:"r18_index,2,required" bson:"r18_index" form:"r18_index,required" json:"r18_index,required" query:"r18_index,required"`
	Status       DownloadTaskStatus `thrift:"status,3,required" bson:"status" form:"status,required" json:"status,required" query:"status,required"`
	CreateTime   string             `thrift:"create_time,4,required" bson:"create_time" form:"create_time,required" json:"create_time,required" query:"create_time,required"`
	UpdateTime   string             `thrift:"update_time,5,required" bson:"update_time" form:"update_time,required" json:"update_time,required" query:"update_time,required"`
	RetryTime    int32              `thrift:"retry_time,6,required" bson:"retry_time" form:"retry_time,required" json:"retry_time,required" query:"retry_time,required"`
	LastRunTime  string             `thrift:"last_run_time,7,required" bson:"last_run_time" form:"last_run_time,required" json:"last_run_time,required" query:"last_run_time,required"`
	LastRunError string             `thrift:"last_run_error,8,required" bson:"last_run_error" form:"last_run_error,required" json:"last_run_error,required" query:"last_run_error,required"`
}
...
func (p *DownloadTask) GetIllustID() (v string) {
	return p.IllustID
}

func (p *DownloadTask) GetR18Index() (v int32) {
	return p.R18Index
}

func (p *DownloadTask) GetStatus() (v DownloadTaskStatus) {
	return p.Status
}

func (p *DownloadTask) GetCreateTime() (v string) {
	return p.CreateTime
}

func (p *DownloadTask) GetUpdateTime() (v string) {
	return p.UpdateTime
}

func (p *DownloadTask) GetRetryTime() (v int32) {
	return p.RetryTime
}

func (p *DownloadTask) GetLastRunTime() (v string) {
	return p.LastRunTime
}

func (p *DownloadTask) GetLastRunError() (v string) {
	return p.LastRunError
}

var fieldIDToName_DownloadTask = map[int16]string{
	1: "illust_id",
	2: "r18_index",
	3: "status",
	4: "create_time",
...
func (p *DownloadTask) Read(iprot thrift.TProtocol) (err error) {

	var fieldTypeId thrift.TType
	var fieldId int16
	var issetIllustID bool = false
	var issetR18Index bool = false
	var issetStatus bool = false
	var issetCreateTime bool = false
	var issetUpdateTime bool = false
	var issetRetryTime bool = false
	var issetLastRunTime bool = false
	var issetLastRunError bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DownloadTask[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_DownloadTask[fieldId]))
}

func (p *DownloadTask) ReadField1(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField2(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField3(iprot thrift.TProtocol) error {

	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.Status = DownloadTaskStatus(v)
	}
	return nil
}
func (p *DownloadTask) ReadField4(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField5(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField6(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField7(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) ReadField8(iprot thrift.TProtocol) error {
...
func (p *DownloadTask) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("DownloadTask"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *DownloadTask) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("illust_id", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.IllustID); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *DownloadTask) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("r18_index", thrift.I32, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.R18Index); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *DownloadTask) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *DownloadTask) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *DownloadTask) writeField5(oprot thrift.TProtocol) (err error) {
...
func (p *DownloadTask) writeField6(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("retry_time", thrift.I32, 6); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.RetryTime); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *DownloadTask) writeField7(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("last_run_time", thrift.STRING, 7); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.LastRunTime); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *DownloadTask) writeField8(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("last_run_error", thrift.STRING, 8); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.LastRunError); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *DownloadTask) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DownloadTask(%+v)", *p)

}

type AddDownloadTaskRequest struct {
	IllustID string `thrift:"illust_id,1,required" form:"illust_id,required" json:"illust_id,required" query:"illust_id,required" vd:"len($) > 0; msg:'illust_id is empty'"`
	R18Index int32  `thrift:"r18_index,2,required" form:"r18_index,required" json:"r18_index,required" query:"r18_index,required" vd:"$ >= 0; msg:'r18_index must be greater than or equal to 0'"`
}

func NewAddDownloadTaskRequest() *AddDownloadTaskRequest {
	return &AddDownloadTaskRequest{}
}

func (p *AddDownloadTaskRequest) GetIllustID() (v string) {
	return p.IllustID
}

func (p *AddDownloadTaskRequest) GetR18Index() (v int32) {
	return p.R18Index
}

var fieldIDToName_AddDownloadTaskRequest = map[int16]string{
	1: "illust_id",
	2: "r18_index",
}

func (p *AddDownloadTaskRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_AddDownloadTaskRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_AddDownloadTaskRequest[fieldId]))
}

func (p *AddDownloadTaskRequest) ReadField1(iprot thrift.TProtocol) error {
...
func (p *AddDownloadTaskRequest) ReadField2(iprot thrift.TProtocol) error {
...
func (p *AddDownloadTaskRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("AddDownloadTaskRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *AddDownloadTaskRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("illust_id", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.IllustID); err != nil {
...
func (p *AddDownloadTaskRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("r18_index", thrift.I32, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.R18Index); err != nil {
...
func (p *AddDownloadTaskRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AddDownloadTaskRequest(%+v)", *p)
...
func NewAddDownloadTaskResponse() *AddDownloadTaskResponse {
	return &AddDownloadTaskResponse{}
}

func (p *AddDownloadTaskResponse) GetCode() (v int32) {
	return p.Code
}

func (p *AddDownloadTaskResponse) GetMsg() (v string) {
	return p.Msg
}

var fieldIDToName_AddDownloadTaskResponse = map[int16]string{
	1: "code",
	2: "msg",
}

func (p *AddDownloadTaskResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_AddDownloadTaskResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_AddDownloadTaskResponse[fieldId]))
}

func (p *AddDownloadTaskResponse) ReadField1(iprot thrift.TProtocol) error {
...
func (p *AddDownloadTaskResponse) ReadField2(iprot thrift.TProtocol) error {
...
func (p *AddDownloadTaskResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("AddDownloadTaskResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *AddDownloadTaskResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("code", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Code); err != nil {
...
func (p *AddDownloadTaskResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("msg", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Msg); err != nil {
...
func (p *AddDownloadTaskResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AddDownloadTaskResponse(%+v)", *p)
