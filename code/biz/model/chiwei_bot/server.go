...
type ChiweiBotService interface {
	Register(ctx context.Context, request *auth.RegisterRequest) (r *auth.RegisterResponse, err error)
...
func (p *ChiweiBotServiceClient) Register(ctx context.Context, request *auth.RegisterRequest) (r *auth.RegisterResponse, err error) {
	var _args ChiweiBotServiceRegisterArgs
	_args.Request = request
	var _result ChiweiBotServiceRegisterResult
...
func NewChiweiBotServiceProcessor(handler ChiweiBotService) *ChiweiBotServiceProcessor {
	...
	self.AddToProcessorMap("Register", &chiweiBotServiceProcessorRegister{handler: handler})
...
type chiweiBotServiceProcessorRegister struct {
	handler ChiweiBotService
}

func (p *chiweiBotServiceProcessorRegister) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ChiweiBotServiceRegisterArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := ChiweiBotServiceRegisterResult{}
	var retval *auth.RegisterResponse
...
type ChiweiBotServiceRegisterArgs struct {
	Request *auth.RegisterRequest `thrift:"request,1"`
}

func NewChiweiBotServiceRegisterArgs() *ChiweiBotServiceRegisterArgs {
	return &ChiweiBotServiceRegisterArgs{}
}

var ChiweiBotServiceRegisterArgs_Request_DEFAULT *auth.RegisterRequest

func (p *ChiweiBotServiceRegisterArgs) GetRequest() (v *auth.RegisterRequest) {
	if !p.IsSetRequest() {
		return ChiweiBotServiceRegisterArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_ChiweiBotServiceRegisterArgs = map[int16]string{
	1: "request",
}

func (p *ChiweiBotServiceRegisterArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *ChiweiBotServiceRegisterArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ChiweiBotServiceRegisterArgs[fieldId]), err)
SkipFieldError:
...
func (p *ChiweiBotServiceRegisterArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = auth.NewRegisterRequest()
...
func (p *ChiweiBotServiceRegisterArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *ChiweiBotServiceRegisterArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *ChiweiBotServiceRegisterArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ChiweiBotServiceRegisterArgs(%+v)", *p)

}

type ChiweiBotServiceRegisterResult struct {
	Success *auth.RegisterResponse `thrift:"success,0,optional"`
}

func NewChiweiBotServiceRegisterResult() *ChiweiBotServiceRegisterResult {
	return &ChiweiBotServiceRegisterResult{}
}

var ChiweiBotServiceRegisterResult_Success_DEFAULT *auth.RegisterResponse

func (p *ChiweiBotServiceRegisterResult) GetSuccess() (v *auth.RegisterResponse) {
	if !p.IsSetSuccess() {
		return ChiweiBotServiceRegisterResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_ChiweiBotServiceRegisterResult = map[int16]string{
	0: "success",
}

func (p *ChiweiBotServiceRegisterResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ChiweiBotServiceRegisterResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ChiweiBotServiceRegisterResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *ChiweiBotServiceRegisterResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = auth.NewRegisterResponse()
...
func (p *ChiweiBotServiceRegisterResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *ChiweiBotServiceRegisterResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *ChiweiBotServiceRegisterResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ChiweiBotServiceRegisterResult(%+v)", *p)
